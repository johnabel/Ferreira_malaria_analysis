"""
This file is modified from Peter St. John's decaying sinusoid fitting to 
work on RNAseq data.

Major changes:
- forced period to match LSPgram
- no lowpass filtering
- parameter bounds changed to reflect short time series
- remove outlier rejection

- other edits made for Yongli
"""
...
class DecayingSinusoid(object):
    ...
    def _estimate_parameters(self, period_guess=None):
